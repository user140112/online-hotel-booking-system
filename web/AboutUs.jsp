<%-- 
    Document   : AboutUs
    Created on : Mar 20, 2018, 2:55:26 PM
    Author     : SUJAN
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            h1{padding: 20px;background-color: #051019;color: aliceblue;border-radius: 10px;}
            p{font-family: cursive;font-size: 18px;padding: 20px;background-color: #0c6996;color: thistle;border-radius: 10px;}
            address{padding: 40px;background-color: #333333;color: aliceblue;border-radius: 10px;}
        </style>
    </head>
    <body>
        <h1>About Us</h1>
